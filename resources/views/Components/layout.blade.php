        ...
        <nav class="bg-gray-800">
                    ...
                    <div class="flex items-center">
                        ...
                        <div class="hidden md:block">
                            <div class="ml-10 flex items-baseline space-x-4">
                                <x-nav-link link="/" :active="request()->is('/')" label="Home" />
                                <x-nav-link link="/about" :active="request()->is('about')" label="About" />
                                <x-nav-link link="/contact" :active="request()->is('contact')" label="Contact" />
                            </div>
                        </div>
                    </div>
                    <div class="hidden md:block">
            ...
            <div class="md:hidden" id="mobile-menu">
                <div class="space-y-1 px-2 pt-2 pb-3 sm:px-3">
                    ...
                    <x-nav-link link="/" active="{{ request()->is('/') }}" label="Home" :mobile="true" />
                    <x-nav-link link="/about" active="{{ request()->is('about') }}" label="About" :mobile="true" />
                    <x-nav-link link="/contact" active="{{ request()->is('contact') }}" label="Contact"
                        :mobile="true" />
                </div>
